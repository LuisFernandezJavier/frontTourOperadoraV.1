...
const routes: Routes = [
  ...
  { path: 'itinerario/:_itinerarioId/:_coordenadas', component: ItinerarioComponent },
  ...
  { path: 'adminControl', component: AdmiControlComponent, canActivate: [GuardService], data: { expectedRol: ['admin'] } },
  { path: '**', component: HomeComponent }
